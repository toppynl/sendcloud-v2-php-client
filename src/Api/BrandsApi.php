...
class BrandsApi
{
    ...
    /**
     * Operation scPublicV2BrandsGetAllUserBrands
     *
    ...
    {
        [$response] = $this->scPublicV2BrandsGetAllUserBrandsWithHttpInfo();
        return $response;
    }

    /**
     * Operation scPublicV2BrandsGetAllUserBrandsWithHttpInfo
     *
     * Retrieve a list of brands
     *
     *
    ...
    /**
     * Operation scPublicV2BrandsGetAllUserBrandsAsync
     *
     * Retrieve a list of brands
     *
     *
     ...
     * @return Promise
     */
    public function scPublicV2BrandsGetAllUserBrandsAsync()
    {
        return $this->scPublicV2BrandsGetAllUserBrandsAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation scPublicV2BrandsGetAllUserBrandsAsyncWithHttpInfo
     *
     * Retrieve a list of brands
     *
     *
    ...
    /**
     * Create request for operation 'scPublicV2BrandsGetAllUserBrands'
     *
     *
     * @throws \InvalidArgumentException
     * @return RequestInterface
     */
    public function scPublicV2BrandsGetAllUserBrandsRequest()
    {
    ...
    /**
     * Operation scPublicV2BrandsGetUserBrandById
     *
     * Retrieve a brand
     *
    ...
    {
        [$response] = $this->scPublicV2BrandsGetUserBrandByIdWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation scPublicV2BrandsGetUserBrandByIdWithHttpInfo
     *
     * Retrieve a brand
     *
     * @param  int $id The unique id of the user&#39;s configured brand (required)
    ...
    /**
     * Operation scPublicV2BrandsGetUserBrandByIdAsync
     *
     * Retrieve a brand
     *
     * @param  int $id The unique id of the user&#39;s configured brand (required)
     ...
     * @return Promise
     */
    public function scPublicV2BrandsGetUserBrandByIdAsync($id)
    {
        return $this->scPublicV2BrandsGetUserBrandByIdAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation scPublicV2BrandsGetUserBrandByIdAsyncWithHttpInfo
     *
     * Retrieve a brand
     *
     * @param  int $id The unique id of the user&#39;s configured brand (required)
    ...
    /**
     * Create request for operation 'scPublicV2BrandsGetUserBrandById'
     *
     * @param  int $id The unique id of the user&#39;s configured brand (required)
     *
     * @throws \InvalidArgumentException
     * @return RequestInterface
     */
    public function scPublicV2BrandsGetUserBrandByIdRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && $id === [])) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling scPublicV2BrandsGetUserBrandById'
            );
        }

        if ($id < 1) {
            throw new \InvalidArgumentException('invalid value for "$id" when calling BrandsApi.scPublicV2BrandsGetUserBrandById, must be bigger than or equal to 1.');
        }
