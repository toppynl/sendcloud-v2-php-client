...
class ReturnsApi
{
    ...
    /**
     * Operation scPublicV2ScpGetAllReturns
     *
    ...
    {
        [$response] = $this->scPublicV2ScpGetAllReturnsWithHttpInfo($cursor);
        return $response;
    }

    /**
     * Operation scPublicV2ScpGetAllReturnsWithHttpInfo
     *
     * Retrieve a list of returns
     *
     * @param  string $cursor The cursor query string will be used as the pivot value to filter results. If no value is provided, the service must return the first page. The value is Base64 encoded GET parameters. example:   For a cursor string there are 3 possible parameters to encode:   - o: Offset   - r: Reverse   - p: Position   Combine into GET parameters. Example: r&#x3D;1&amp;p&#x3D;300   Base 64 encoded it would become: cj0xJnA9MzAw   GET parameter in url would be https://some.url.com/api/endpoint/?cursor&#x3D;cj0xJnA9MzAw (optional)
    ...
    /**
     * Operation scPublicV2ScpGetAllReturnsAsync
     *
     * Retrieve a list of returns
     *
     * @param  string $cursor The cursor query string will be used as the pivot value to filter results. If no value is provided, the service must return the first page. The value is Base64 encoded GET parameters. example:   For a cursor string there are 3 possible parameters to encode:   - o: Offset   - r: Reverse   - p: Position   Combine into GET parameters. Example: r&#x3D;1&amp;p&#x3D;300   Base 64 encoded it would become: cj0xJnA9MzAw   GET parameter in url would be https://some.url.com/api/endpoint/?cursor&#x3D;cj0xJnA9MzAw (optional)
     ...
     * @return Promise
     */
    public function scPublicV2ScpGetAllReturnsAsync($cursor = null)
    {
        return $this->scPublicV2ScpGetAllReturnsAsyncWithHttpInfo($cursor)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation scPublicV2ScpGetAllReturnsAsyncWithHttpInfo
     *
     * Retrieve a list of returns
     *
     * @param  string $cursor The cursor query string will be used as the pivot value to filter results. If no value is provided, the service must return the first page. The value is Base64 encoded GET parameters. example:   For a cursor string there are 3 possible parameters to encode:   - o: Offset   - r: Reverse   - p: Position   Combine into GET parameters. Example: r&#x3D;1&amp;p&#x3D;300   Base 64 encoded it would become: cj0xJnA9MzAw   GET parameter in url would be https://some.url.com/api/endpoint/?cursor&#x3D;cj0xJnA9MzAw (optional)
    ...
    /**
     * Create request for operation 'scPublicV2ScpGetAllReturns'
     *
     * @param  string $cursor The cursor query string will be used as the pivot value to filter results. If no value is provided, the service must return the first page. The value is Base64 encoded GET parameters. example:   For a cursor string there are 3 possible parameters to encode:   - o: Offset   - r: Reverse   - p: Position   Combine into GET parameters. Example: r&#x3D;1&amp;p&#x3D;300   Base 64 encoded it would become: cj0xJnA9MzAw   GET parameter in url would be https://some.url.com/api/endpoint/?cursor&#x3D;cj0xJnA9MzAw (optional)
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function scPublicV2ScpGetAllReturnsRequest($cursor = null)
    {
    ...
    /**
     * Operation scPublicV2ScpGetReturnById
     *
     * Retrieve a return
     *
    ...
    {
        [$response] = $this->scPublicV2ScpGetReturnByIdWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation scPublicV2ScpGetReturnByIdWithHttpInfo
     *
     * Retrieve a return
     *
     * @param  int $id The unique identifier of this return object (required)
    ...
    /**
     * Operation scPublicV2ScpGetReturnByIdAsync
     *
     * Retrieve a return
     *
     * @param  int $id The unique identifier of this return object (required)
     ...
     * @return Promise
     */
    public function scPublicV2ScpGetReturnByIdAsync($id)
    {
        return $this->scPublicV2ScpGetReturnByIdAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation scPublicV2ScpGetReturnByIdAsyncWithHttpInfo
     *
     * Retrieve a return
     *
     * @param  int $id The unique identifier of this return object (required)
    ...
    /**
     * Create request for operation 'scPublicV2ScpGetReturnById'
     *
     * @param  int $id The unique identifier of this return object (required)
     *
     * @throws \InvalidArgumentException
     * @return RequestInterface
     */
    public function scPublicV2ScpGetReturnByIdRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && $id === [])) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling scPublicV2ScpGetReturnById'
            );
        }
