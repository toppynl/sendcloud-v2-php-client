...
class SenderAddressApi
{
    ...
    /**
     * Operation scPublicV2AddressesGetAllSenderAddresses
     *
    ...
    {
        [$response] = $this->scPublicV2AddressesGetAllSenderAddressesWithHttpInfo();
        return $response;
    }

    /**
     * Operation scPublicV2AddressesGetAllSenderAddressesWithHttpInfo
     *
     * Retrieve a list of sender addresses
     *
     *
    ...
    /**
     * Operation scPublicV2AddressesGetAllSenderAddressesAsync
     *
     * Retrieve a list of sender addresses
     *
     *
     ...
     * @return Promise
     */
    public function scPublicV2AddressesGetAllSenderAddressesAsync()
    {
        return $this->scPublicV2AddressesGetAllSenderAddressesAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation scPublicV2AddressesGetAllSenderAddressesAsyncWithHttpInfo
     *
     * Retrieve a list of sender addresses
     *
     *
    ...
    /**
     * Create request for operation 'scPublicV2AddressesGetAllSenderAddresses'
     *
     *
     * @throws \InvalidArgumentException
     * @return RequestInterface
     */
    public function scPublicV2AddressesGetAllSenderAddressesRequest()
    {

        $resourcePath = '/user/addresses/sender';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = null;
    ...
    /**
     * Operation scPublicV2AddressesGetSenderAddressById
     *
    ...
    {
        [$response] = $this->scPublicV2AddressesGetSenderAddressByIdWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation scPublicV2AddressesGetSenderAddressByIdWithHttpInfo
     *
     * Retrieve a sender address
     *
     * @param  int $id The sender address unique identifier (required)
    ...
    /**
     * Operation scPublicV2AddressesGetSenderAddressByIdAsync
     *
     * Retrieve a sender address
     *
     * @param  int $id The sender address unique identifier (required)
     ...
     * @return Promise
     */
    public function scPublicV2AddressesGetSenderAddressByIdAsync($id)
    {
        return $this->scPublicV2AddressesGetSenderAddressByIdAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation scPublicV2AddressesGetSenderAddressByIdAsyncWithHttpInfo
     *
     * Retrieve a sender address
     *
     * @param  int $id The sender address unique identifier (required)
    ...
    /**
     * Create request for operation 'scPublicV2AddressesGetSenderAddressById'
     *
     * @param  int $id The sender address unique identifier (required)
     *
     * @throws \InvalidArgumentException
     * @return RequestInterface
     */
    public function scPublicV2AddressesGetSenderAddressByIdRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && $id === [])) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling scPublicV2AddressesGetSenderAddressById'
            );
        }

        $resourcePath = '/user/addresses/sender/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = null;
