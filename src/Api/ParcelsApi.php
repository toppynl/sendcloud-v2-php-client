...
class ParcelsApi
{
     ...
     * Retrieve parcels
     *
     * @param  int $parcelStatus Returns parcels that have the requested status. For a list of possible statuses, see the [Parcel statuses](https://api.sendcloud.dev/docs/sendcloud-public-api/parcel-statuses/operations/list-parcel-statuses) endpoint (optional)
     ...
     * @return \Toppy\Sendcloud\Model\ScPublicV2ScpGetAllParcels200Response|\Toppy\Sendcloud\Model\ScPublicV2ScpPostFinalizeBox400Response
     */
     ...
     * @throws \Toppy\Sendcloud\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Toppy\Sendcloud\Model\ScPublicV2ScpGetAllParcels200Response|\Toppy\Sendcloud\Model\ScPublicV2ScpPostFinalizeBox400Response, HTTP status code, HTTP response headers (array of strings)
     */
