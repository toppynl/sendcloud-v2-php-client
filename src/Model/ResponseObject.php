 ...
 */
class ResponseObject implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Response_object';
     ...
     * Sets headers
     *
     * @param object|null $headers HTTP headers which were sent within a response
     *
     * @return self
     */
