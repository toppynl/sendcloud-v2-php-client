...
/**
 * CancelParcelStatus Class Doc Comment
 *
 * @category Class
 * @package  Toppy\Sendcloud\V2
 * @author   OpenAPI Generator team
 ...
 */
class CancelParcelStatus implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CancelParcelStatus';
    ...
    public function setStatus($status)
    {
        ...
        if ((mb_strlen($status) < 1)) {
            throw new \InvalidArgumentException('invalid length for $status when calling CancelParcelStatus., must be bigger than or equal to 1.');
        }
    ...
    public function setMessage($message)
    {
        ...
        if ((mb_strlen($message) < 1)) {
            throw new \InvalidArgumentException('invalid length for $message when calling CancelParcelStatus., must be bigger than or equal to 1.');
        }
