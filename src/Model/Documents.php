...
class Documents implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
     ...
     * Sets size
     *
     * @param string|null $size The paper size of the document, you can expect: a4 and a6.
     *
     * @return self
     */
