 ...
 */
class ScPublicV2AddressesGetAllSenderAddresses200Response implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'sc_public_v2_addresses_get_all_sender_addresses_200_response';
    ...
    protected static $setters = [
        'senderAddresses' => 'setSenderAddresses'
    ];
    ...
    protected static $getters = [
        'senderAddresses' => 'getSenderAddresses'
    ];
    ...
    {
        $this->setIfExists('senderAddresses', $data ?? [], null);
    }
    ...
    {
        return $this->container['senderAddresses'];
    }
     ...
     * @return self
     */
    public function setSenderAddresses($senderAddresses)
    {
        if (is_null($senderAddresses)) {
            throw new \InvalidArgumentException('non-nullable senderAddresses cannot be null');
        }

        $this->container['senderAddresses'] = $senderAddresses;
