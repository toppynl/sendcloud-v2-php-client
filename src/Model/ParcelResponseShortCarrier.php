 ...
 */
class ParcelResponseShortCarrier implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ParcelResponseShort_carrier';
