 ...
 */
class ScPublicV2OrdersGetRetrieveAListOfShipments200Response implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'sc_public_v2_orders_get_retrieve_a_list_of_shipments_200_response';
     ...
     * Sets next
     *
     * @param string|null $next Cursor based pagination url to go forward. By following this URL you can get a next batch of shipments
     *
     * @return self
     */
     ...
     * Sets previous
     *
     * @param string|null $previous Cursor based pagination url to go backwards. By following this URL you can get a previous batch of shipments
     *
     * @return self
     */
