 ...
 */
class ScPublicV2ScpGetAllParcels200Response implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'sc_public_v2_scp_get_all_parcels_200_response';
    ...
    public function setParcels($parcels)
    {
        ...
        if ((count($parcels) < 1)) {
            throw new \InvalidArgumentException('invalid length for $parcels when calling ScPublicV2ScpGetAllParcels200Response., number of items must be greater than or equal to 1.');
        }
