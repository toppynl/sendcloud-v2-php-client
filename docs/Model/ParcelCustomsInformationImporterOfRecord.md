...
**address1** | **string** | Address of IOR |
...
**countryState** | **string** | Code of the state (e.g. NY for New York) or province (e.g. RM for Rome). Destinations that require this field are USA, Canada, Italy and Australia. Format ISO-3166-2. | [optional]
