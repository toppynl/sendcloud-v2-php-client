...
**countries** | [**\Toppy\Sendcloud\V2\Model\ShippingMethodsShippingMethodCountriesInner[]**](ShippingMethodsShippingMethodCountriesInner.md) | A list of countries that you can ship to with the shipping method. | [optional]
