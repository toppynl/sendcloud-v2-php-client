...
**addressDivided** | [**\Toppy\Sendcloud\Model\AddressDivided**](AddressDivided.md) |  | [optional]
**carrier** | [**\Toppy\Sendcloud\Model\ParcelResponseShortCarrier**](ParcelResponseShortCarrier.md) |  | [optional]
**city** | **string** |  | [optional]
**companyName** | **string** |  | [optional]
**contract** | **int** | Id of the contract that was used to create the parcel. | [optional]
**country** | [**\Toppy\Sendcloud\Model\Country**](Country.md) |  | [optional]
...
**label** | [**\Toppy\Sendcloud\Model\Label**](Label.md) |  | [optional]
**name** | **string** |  | [optional]
**orderNumber** | **string** |  | [optional]
**shipmentUuid** | **string** |  | [optional]
**parcelItems** | [**\Toppy\Sendcloud\Model\ParcelItem[]**](ParcelItem.md) |  | [optional]
...
**documents** | [**\Toppy\Sendcloud\Model\Documents[]**](Documents.md) | An array of documents. A parcel can contain multiple documents, for instance labels and a customs form. This field returns an array of all the available documents for this parcel. | [optional]
...
**errors** | [**\Toppy\Sendcloud\Model\CarrierErrors**](CarrierErrors.md) |  | [optional]
