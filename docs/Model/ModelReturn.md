...
**refund** | [**\Toppy\Sendcloud\V2\Model\ReturnRefund**](ReturnRefund.md) |  | [optional]
...
**outgoingParcelData** | [**\Toppy\Sendcloud\V2\Model\ReturnParcel**](ReturnParcel.md) |  | [optional]
**incomingParcelData** | [**\Toppy\Sendcloud\V2\Model\ReturnIncomingParcelData**](ReturnIncomingParcelData.md) |  | [optional]
**incomingParcelStatus** | [**\Toppy\Sendcloud\V2\Model\ReturnIncomingParcelStatus**](ReturnIncomingParcelStatus.md) |  | [optional]
**images** | [**\Toppy\Sendcloud\V2\Model\ReturnImageObject[]**](ReturnImageObject.md) | A list of images attached to a return | [optional]
**ruleModifications** | [**\Toppy\Sendcloud\V2\Model\ReturnRuleModificationsInner[]**](ReturnRuleModificationsInner.md) | List of return rules applied to this Return | [optional]
