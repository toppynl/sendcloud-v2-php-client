# # ScPublicV2ScpPostPickup201ResponseInner
...
**countryState** | **string** | A country state (if applicable). |
...
**pickupUntil** | **\DateTime** | ISO 8601 DateTime of the pickup location close time. This could be useful in case the pickup is delayed. |
**pickupStatus** | **string** |  |
