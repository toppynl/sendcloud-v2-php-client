...
**parcelItems** | [**\Toppy\Sendcloud\V2\Model\ParcelItem[]**](ParcelItem.md) | List of items the order contains. Check the structure of a parcel_item in the “Parcel_items” section (remember, it’s a list of them!). | [optional]
