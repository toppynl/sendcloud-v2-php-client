...
**countries** | [**\Toppy\Sendcloud\Model\ShippingMethodCountriesInner[]**](ShippingMethodCountriesInner.md) | A list of countries that you can ship to with the shipping method. | [optional]
